% Template for an article written in the IEEE style.
...
% Set the title for \maketitle below.
\title{Example paper}
% Likewise set the author(s). The \\ starts a new line.
...
\begin{document}
  ...
  % Most journals provide a standard list keywords for indexing.
  % You should select the most relevant ones from the journal's website.
  \begin{IEEEkeywords}
    IEEE, IEEEtran, journal, \LaTeX, paper, template.
  \end{IEEEkeywords}


  % Begin the paper itself.
  ...
  % Add the bibliography based on the uses of \cite and bibliography.bib.
